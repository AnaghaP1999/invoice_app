                        ...
                        <form method="POST" action="{{ route('generate-invoice') }}" id="invoiceForm" enctype="multipart/form-data" class="mt-6 space-y-6">
                            ...
                            <div class="flex flex-wrap -mx-4">
                                <div class="w-1/2 px-4">
                                    ...
                                    <x-text-input id="quantity" name="quantity" type="text" class="mt-1 block w-full" placeholder="Quantity" value="{{ old('quantity') }}"/>
                                    @error('quantity')
                                ...
                                <div class="w-1/2 px-4">
                                    ...
                                    <x-text-input id="amount" name="amount" type="text" class="mt-1 block w-full" placeholder="Amount" value="{{ old('amount') }}"/>
                                    @error('amount')
                                ...
                                <div class="w-1/2 px-4">
                                    ...
                                    <x-text-input id="total_amount" name="total_amount" type="text" class="mt-1 block w-full" placeholder="Total Amount" value="{{ old('total_amount') }}" readonly/>
                                </div>

                                <div class="w-1/2 px-4">
                                    <x-input-label for="tax_perc" :value="__('Tax Percentage')"/>
                                        <select id="tax_perc" name="tax_perc" class="mt-1 block w-1/2" placeholder="Tax Percentage">
                                ...
                                <div class="w-1/2 px-4">
                                    ...
                                    <x-text-input id="tax_amount" name="tax_amount" type="text" class="mt-1 block w-full" placeholder="Tax Amount" value="{{ old('tax_amount') }}" readonly/>
                                </div>
                            </div>
                            <div class="flex flex-wrap -mx-4">
                                <div class="w-1/2 px-4">
                                    <x-input-label for="net_amount" :value="__('Net Amount')" />
                                    <x-text-input id="net_amount" name="net_amount" type="text" class="mt-1 block w-full" placeholder="Net Amount" value="{{ old('net_amount') }}" readonly/>
                                </div>

                                <div class="w-1/2 px-4">
                                    <x-input-label for="customer_name" :value="__('Customer Name')" />
                                    <x-text-input id="customer_name" name="customer_name" type="text" class="mt-1 block w-full" placeholder="Customer Name" value="{{ old('customer_name') }}"/>
                                    @error('customer_name')
                                ...
                                <div class="w-1/2 px-4">
                                    ...
                                    <x-text-input id="invoice_date" name="invoice_date" type="date" class="mt-1 block w-full" placeholder="Invoice Date" value="{{ old('invoice_date') }}"/>
                                    @error('invoice_date')
                                ...
                                <div class="w-1/2 px-4">
                                    ...
                                    <x-text-input id="customer_email" name="customer_email" type="email" class="mt-1 block w-full" placeholder="Customer Email" value="{{ old('customer_email') }}"/>
                            ...
                            <div class="flex flex-wrap -mx-4">
                                <div class="w-1/2 px-4">
                                    ...
                                    <x-text-input id="image" name="image" type="file" class="mt-1 block w-full" placeholder="Upload File" accept="image/*,application/pdf" value="{{ old('image') }}"/>
                                    @error('image')
